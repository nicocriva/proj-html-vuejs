...
export default {
    ...
    data(){
      return{
        ...
        contacts: [
          {
            name: '63 E. Studebaker Street Bolingbrook, IL 60440',
          },
          {
            name: 'Phone: (800) 000-0000',
          },
          {
            name: 'Mobile: (800) 000-0000'
          },
          {
            name: 'Email: info@your-company.com'
          }
        ],
